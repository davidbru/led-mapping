...
#     print(f"Total LEDs in this row: {leds_per_row[layout_index]} (= Offset)")
...
#         print(len(panel_mapping[panel['layout']]))
...
print(f"LED Matrix:   {led_matrix}")
print(f"StitchedRows: {stitched_rows}")
    ...
    for panel_index, panel in enumerate(layout_row):
        ...
        for row_index, row in enumerate(panel['LED_mapping_1']):
            ...
            for col_index, col in enumerate(row):
                ...
                print(f"row:{row_index}; col:{col_index}; value:{col}; corresponding_value:{corresponding_value}")
